#!/bin/zsh
# P08 Item2 Phase A capture on macstudio-m4-2 (beside live runner PID 60392).
...
.venv/bin/python tmp/p08-20260830/item2_phaseA.py \
  2>&1 | tee tmp/p08-20260830/item2_phaseA_capture.log
