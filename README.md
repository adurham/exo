...
| `EXO_JIT_ENABLED` | Just-in-time model lifecycle: a chat request for a downloaded-but-not-resident model auto-places it, serves it, and unloads it after an idle window (transparent to all clients). Master kill-switch. | `true` |
