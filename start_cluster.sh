...
: "${EXO_MODEL_MAX_CONTEXT_TOKENS:=mlx-community/Qwen3.5-9B-8bit:20000}"
...
for NODE in "${NODES[@]}"; do
    ...
    EXO_ENV="$EXO_ENV MLX_JACCL_FRAME_SIZE=$MLX_JACCL_FRAME_SIZE"
    ...
    EXO_ENV="$EXO_ENV EXO_SUBAGENT_MAX_OUTPUT_TOKENS=$EXO_SUBAGENT_MAX_OUTPUT_TOKENS"
    EXO_ENV="$EXO_ENV EXO_SUBAGENT_TRIM_MESSAGES=$EXO_SUBAGENT_TRIM_MESSAGES"
    EXO_ENV="$EXO_ENV EXO_SUBAGENT_MAX_TOOL_ROUNDS=$EXO_SUBAGENT_MAX_TOOL_ROUNDS"
    EXO_ENV="$EXO_ENV EXO_MODEL_MAX_CONTEXT_TOKENS=$EXO_MODEL_MAX_CONTEXT_TOKENS"
